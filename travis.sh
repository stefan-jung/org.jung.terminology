...
chmod +x dita-ot-3.5.4/bin/ant
chmod +x dita-ot-3.5.4/bin/dita
dita-ot-3.5.4/bin/dita --install https://github.com/oxygenxml/dita-relaxng-defaults/archive/master.zip
dita-ot-3.5.4/bin/dita --install https://github.com/doctales/org.doctales.xmltask/archive/master.zip
dita-ot-3.5.4/bin/dita --install org.doctales.terminology.zip
dita-ot-3.5.4/bin/dita --input dita-ot-3.3.3/plugins/org.doctales.terminology/samples/terminology.ditamap --format termchecker-dita -Dprocessing-mode=strict -Dargs.language=en-GB --output out/termchecker-dita --verbose
dita-ot-3.5.4/bin/dita --input dita-ot-3.3.3/plugins/org.doctales.terminology/samples/terminology.ditamap --format termchecker-xliff -Dprocessing-mode=strict -Dargs.language=en-GB -Dargs.check.elements=both --output out/termchecker-xliff --verbose
dita-ot-3.5.4/bin/dita --input dita-ot-3.3.3/plugins/org.doctales.terminology/samples/terminology.ditamap --format tbx-basic -Dprocessing-mode=strict --output out/tbx-basic --verbose
dita-ot-3.5.4/bin/dita --input dita-ot-3.3.3/plugins/org.doctales.terminology/samples/terminology.ditamap --format tbx-min -Dprocessing-mode=strict -Dargs.source.language=en-GB -Dargs.target.language=de-DE --output out/tbx-min --verbose
