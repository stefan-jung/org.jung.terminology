...
<xsl:stylesheet version="3.0"
    ...
    exclude-result-prefixes="related-links sj xs">
    ...
    <!-- Fall Through Template -->
    <xsl:template match="languages" mode="termstats"/>
    
    <!-- Function to get color code from a list by index. -->
    ...
    <!-- Function to get hover color code from a list by index. -->
